...
public enum Terminal {
	...
	case characterSet(set: CharacterSet, hash: Int)
}
...
extension Terminal: Hashable {
	...
	public var hashValue: Int {
		...
		case .characterRange(range: _, hash: let hash),
		     .regularExpression(expression: _, hash: let hash),
		     .string(string: _, hash: let hash),
		     .characterSet(_, let hash):
			return hash
		}
	}
...
extension Terminal: Codable {
	public init(from decoder: Decoder) throws {
		...
		case .characterSet:
			let aSet = try container.decode(CharacterSet.self, forKey: .value)
			self = .characterSet(set: aSet, hash: aSet.hashValue)
		}
	}
	...
	public func encode(to encoder: Encoder) throws {
		...
		case .characterSet(let aSet, _):
			try container.encode(TerminalCoding.characterSet, forKey: .type)
			try container.encode(aSet, forKey: .value)
		}	
	}
