...
public extension Terminal {
	...
	public init(range: ClosedRange<Character>) {
		self = .characterRange(range: range, hash: ClosedCharacterRange(range).hashValue)
	}
...
extension Terminal: Codable {
	public init(from decoder: Decoder) throws {
		...
		case .characterRange:
			let range = try container.decode(ClosedCharacterRange.self, forKey: .value).range
			self = .characterRange(range: range, hash: ClosedCharacterRange(range).hashValue)
	...
	public func encode(to encoder: Encoder) throws {
		...
		case .characterRange(let range, _):
			...
			try container.encode(ClosedCharacterRange(range), forKey: .value)
...
struct ClosedCharacterRange: Hashable {
	...
	public static func == (lhs: ClosedCharacterRange, rhs: ClosedCharacterRange) -> Bool {
		return lhs.lowerBound == rhs.lowerBound && lhs.upperBound == rhs.upperBound
	}
	
}

extension ClosedCharacterRange: Codable {
	public init(from decoder: Decoder) throws {
		let container = try decoder.container(keyedBy: CodingKeys.self)
		let lower = try container.decode(String.self, forKey: .lowerBound)
		let upper = try container.decode(String.self, forKey: .upperBound)
		...
		self.init(lowerBound: lower[lower.startIndex], upperBound: upper[upper.startIndex])
	}
	...
	public var range: ClosedRange<Character> {
		return ClosedRange<Character>(uncheckedBounds: (lowerBound, upperBound))
	}
}
